...
<!-- Mirrored from alearslan.com/alia/umag-news-magazine-blog-template/Light-Version/wide/standard-post.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 Aug 2021 16:14:52 GMT -->
<head>
		<title>UMAG - News, Magazine, Blog Template</title>
		<meta charset="utf-8">
		<!--[if IE]>
	...
	<body>
		...
		<header>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-4 col-md-2 logo"><a href="index.html"><img src="images/logo.png" alt=""></a></div>
				...
				<div class="row">
							...
							<div class="row">
								<article class="col-lg-12 col-md-12">
									<div class="picture">
										<div class="category-image">
											<img src="http://placehold.it/800x550" class="img-responsive" alt="" >
											<h2 class="overlay-category">LONDON CATWALK 2014</h2>
										</div>
									</div>
									<div class="detail">
										<div class="info">
										...
										<div class="caption">Morbi in sem quis dui placerat ornare. Pellentesque odio nisi, euismod in, pharetra a, ultricies in, diam. Sed arcu. Cras consequat.</div>
										<div class="author">
											<div class="pic">
									...
									<div class="row next-n-prev">
										<article class="col-lg-6 col-md-6 col-sm-6">
											<div class="detail">
												...
												<div class="btns"><a href="#"><i class="fa fa-angle-double-left"></i> PREVIOUS ARTICLE</a></div>
											</div>
										</article>
										<!-- ARTICLE ENDS -->
										<!-- ARTICLE STARTS -->
										<article class="col-lg-6 col-md-6 col-sm-6">
											<div class="detail">
												...
												<div class="btns"><a href="#">NEXT ARTICLE <i class="fa fa-angle-double-right"></i></a></div>
											</div>
										</article>
									</div>
									<!-- Next & Prev. Ends -->               
									...
									<div class="about-author">
										<div class="row category-caption">
											<div class="col-lg-6">
												<h2 class="pull-left">ABOUT AUTHOR</h2>
											</div>
											<div class="col-lg-6">
										...
										<div class="row">
											<div class="col-lg-12">
												<img src="http://placehold.it/120x120" class="img-circle pull-left" alt="" >
												<div class="name">John Doe</div>
												<div class="intro">Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo. Quisque sit amet est et sapien ullamcorper pharetra. Vestibulum erat wisi, condimentum.</div>
											</div>
										</div>
									</div>
									<!-- About Author Ends -->               
					...
					<div class="col-lg-4">
						...
						<div class="tabs">
							<div role="tabpanel">
								...
								<ul class="nav nav-tabs nav-justified" role="tablist">
									<li role="presentation" class="active"><a href="#categories" aria-controls="popular" role="tab" data-toggle="tab">CATEGORIES</a></li>
								...
								<div class="tab-content">
									...
									<div role="tabpanel" class="tab-pane active" id="categories">
										<div class="categories">
											<ul class="cats">
												<li><img src="http://placehold.it/50x50" class="img-circle" alt="" > <a href="#">Fashion</a> <span class="pull-right">50</span></li>
												<li><img src="http://placehold.it/50x50" class="img-circle" alt="" > <a href="#">Photography</a> <span class="pull-right">99</span></li>
												<li><img src="http://placehold.it/50x50" class="img-circle" alt="" > <a href="#">Food</a> <span class="pull-right">75</span></li>
												<li><img src="http://placehold.it/50x50" class="img-circle" alt="" > <a href="#">Sports</a> <span class="pull-right">34</span></li>
												<li><img src="http://placehold.it/50x50" class="img-circle" alt="" > <a href="#">Technology</a> <span class="pull-right">09</span></li>
											</ul>
										</div>
									</div>
									<!-- Categories Ends -->
									...
									<div role="tabpanel" class="tab-pane" id="popular">
										<ul class="tabs-posts">
											<li>
												<div class="pic"><img src="http://placehold.it/75x75" class="img-responsive" alt="" ></div>
												<div class="info">
													<span class="date"><i class="fa fa-calendar-o"></i> 01/01/2015</span>                        
													<span class="comments pull-right"><i class="fa fa-comment-o"></i> 750</span>
													<span class="likes pull-right"><i class="fa fa-heart-o"></i> 500</span>
						...
						<div class="featured-video">
							...
							<div class="featured-video-carousel">
								...
								<div>
									<div class="picture">
										<div class="category-image">
											<img src="http://placehold.it/720x800" class="img-responsive" alt="" >
											<div class="bg">&nbsp;</div>
											<h2 class="overlay-category">FASHION</h2>
											<div class="play-button"><a href="#"><img src="images/icons/video-icon.png" width="40" height="40" alt="" ></a></div>
										</div>
									</div>
									<div class="detail">
						...
						<div class="featured-authors">
							...
							<ul>
								<li><a href="author-page.html"><img src="http://placehold.it/70x70" alt="" ></a></li>
								<li><a href="author-page.html"><img src="http://placehold.it/70x70" alt="" ></a></li>
								<li><a href="author-page.html"><img src="http://placehold.it/70x70" alt="" ></a></li>
								<li><a href="author-page.html"><img src="http://placehold.it/70x70" alt="" ></a></li>
								<li><a href="author-page.html"><img src="http://placehold.it/70x70" alt="" ></a></li>
						...
						<div class="ad-125x125">
							<div class="row">
								...
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6"><img src="images/ads/125x125/4.jpg" width="125" height="125" alt="" ></div>
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6"><img src="images/ads/125x125/6.gif" width="125" height="125" alt="" ></div>
							</div>
						</div>
						<!-- ADVERTISEMENT 300 X 250 ENDS -->
					</div>
		...
		<section class="footer">
			...
			<div class="row3">
				<div class="container">
					<div class="row">
						<div class="col-lg-12 copyright">© Copyright 2015 - UMag</div>
					</div>
				</div>
			</div>
			<!-- 3RD ROW ENDS -->
