...
<!-- Mirrored from alearslan.com/alia/umag-news-magazine-blog-template/Light-Version/wide/register.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 Aug 2021 16:14:48 GMT -->
<head>
					...
					<div class="col-lg-8">
						...
						<section>
							...
							<div class="row login-form">
								<div class="col-lg-6 col-lg-offset-3"><input name="" type="text" placeholder="User Name"></div>
								<div class="col-lg-6 col-lg-offset-3"><input name="" type="text" placeholder="Email"></div>
								<div class="col-lg-6 col-lg-offset-3"><input type="button" value="REGISTER"></div>
							</div>
						</section>
						<!-- /. FOOD ENDS
							========================================================================= -->
